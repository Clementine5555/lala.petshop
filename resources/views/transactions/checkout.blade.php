...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-place-order { width: 100%; padding: 15px; background: #FF8C42; color: white; border: none; border-radius: 30px; font-size: 1.1em; font-weight: 700; cursor: pointer; margin-top: 20px; transition: 0.3s; }
        .btn-place-order:hover { background: #e67e3b; }
        @media (max-width: 900px) { .checkout-content { grid-template-columns: 1fr; } .form-row { grid-template-columns: 1fr; } }
    </style>
</head>
<body>
    ...
    <div class="checkout-content">
        <div class="checkout-form">
            ...
            <div style="background:#fee2e2; color:#b91c1c; padding:15px; border-radius:10px; margin-bottom:20px; border: 1px solid #ef4444;">
                <strong>Ups, Gagal!</strong> {{ session('error') }}
            </div>
            @endif
