            ...
            <div style="flex: 1; max-width: 28rem;">
                <div class="card" style="padding: 3rem; border-radius: 32px;">
                    <div style="text-align: center; margin-bottom: 2.5rem;">
                        ...
                        <h1 style="font-size: 2.5rem; font-weight: 900; color: #f97316;">Log In</h1>
                        <p style="color: rgba(249, 115, 22, 0.7); font-size: 0.875rem; margin-top: 0.5rem;">Welcome back! Please login to your account</p>
                    </div>
                    
                    <form method="POST" action="{{ route('login') }}" id="loginForm" style="display: flex; flex-direction: column; gap: 1.75rem;">
                        @csrf
                        
                        <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                            <label for="email" style="color: #f97316; font-weight: 600; font-size: 0.875rem; letter-spacing: 0.5px;">
                                Email Address
                            </label>
                            <div style="position: relative;">
                                <input
                                    ...
                                    name="email"
                                    value="{{ old('email') }}"
                                    style="width: 100%; background: rgba(255, 255, 255, 0.5); border: none; border-bottom: 2px solid #fb923c; padding: 0.75rem 3rem 0.75rem 0; color: #1f2937; font-size: 1rem; transition: all 0.3s ease;"
                                    required
                                    autofocus
                                    autocomplete="username"
                                    placeholder="you@example.com"
                                />
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="position: absolute; right: 0.5rem; top: 50%; transform: translateY(-50%); color: #f97316;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                            <label for="password" style="color: #f97316; font-weight: 600; font-size: 0.875rem; letter-spacing: 0.5px;">
                                Password
                            </label>
                            <div style="position: relative;">
                                <input
                        ...
                        <div style="display: flex; justify-content: center; gap: 2rem; padding-top: 0.5rem; border-top: 1px solid rgba(249, 115, 22, 0.2);">
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" style="color: #c2410c; font-weight: 600; text-decoration: none; font-size: 0.875rem;">
                                    Create Account
                                </a>
                            @endif

                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" style="color: #c2410c; font-weight: 600; text-decoration: none; font-size: 0.875rem;">
                                    Forgot Password?
                                </a>
                            @endif
                        </div>
